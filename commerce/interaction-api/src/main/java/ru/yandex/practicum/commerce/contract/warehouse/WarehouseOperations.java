...
public interface WarehouseOperations {
    ...
    void addProduct (@Valid @RequestBody NewProductInWarehouseRequest request);

    @PostMapping("/api/v1/warehouse/check")
    BookedProductsDto checkProductCount(@Valid @RequestBody ShoppingCartDto shoppingCartDto);
    ...
    void returnToWarehouse(@Valid @RequestBody Map<UUID, Long> products);
